...
class TRY_SEO {
    ...
    protected function get_post_title( $is_default = false ) {
        ...
        $postID = $this->get_post_id( $post );

        $seo_title = ( $is_default ) ? false : trim( get_post_meta( $postID, 'seo_title', true ) );
    ...
    protected function get_post_description( $is_default = false ) {
        ...
        $seo_description = ( $is_default ) ? false : trim( get_post_meta( $postID, 'seo_description', true ) );
    ...
    protected function get_post_keywords() {
        ...
        $seo_description = trim( get_post_meta( $postID, 'seo_keywords', true ) );
    ...
    /**
     * Get the posts ID, while accounting for the ID of the page set as "Posts page".
     * @param Object $post - The global post variable.
     * @return mixed - The ID of the post or page.
     */
